#ifndef TwoDimChartEngineNode_h
#define TwoDimChartEngineNode_h
...
/** @class TwoDimChartEngineNode
*  @brief  Describes an ActivityNode encountered in reading an IM xml file
*
*/

class TwoDimChartEngineNode : public IImActivityNode
{
public:
    typedef std::vector<std::string> StringList;

    TwoDimChartEngineNode(const std::string& type, const std::string& name, const std::string& id) :
                     m_type(type), m_name(name), m_id(id) {m_nodeMap.clear();}
    virtual ~TwoDimChartEngineNode() {}
...
#endif // ifdef TwoDimChartEngineNode_h
