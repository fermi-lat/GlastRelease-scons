#ifndef ClassificationAgreementEngineNode_h
#define ClassificationAgreementEngineNode_h
...
/** @class ClassificationAgreementEngineNode
*  @brief  Describes an ActivityNode encountered in reading an IM xml file
*
*/

class ClassificationAgreementEngineNode : public IImActivityNode
{
public:
    typedef std::vector<std::string> StringList;

    ClassificationAgreementEngineNode(const std::string& type, const std::string& name, const std::string& id) :
                     m_type(type), m_name(name), m_id(id) {m_nodeMap.clear();}
    virtual ~ClassificationAgreementEngineNode() {}
...
#endif // ifdef ClassificationAgreementEngineNode_h
