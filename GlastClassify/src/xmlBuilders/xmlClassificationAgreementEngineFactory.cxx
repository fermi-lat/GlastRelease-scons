/**@file xmlClassificationAgreementEngineFactory.cxx

@brief implementation of class xmlClassificationAgreementEngineFactory
...
xmlClassificationAgreementEngineFactory::xmlClassificationAgreementEngineFactory(XTExprsnParser& parser) : xmlFactoryBase(parser)
{
}

IImActivityNode* xmlClassificationAgreementEngineFactory::operator()(const DOMElement* xmlActivityNode)
{
...
xmlClassificationAgreementEngineFactory::~xmlClassificationAgreementEngineFactory()
{
    ///@TODO: delete trees
}
