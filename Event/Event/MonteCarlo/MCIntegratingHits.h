// $Header$
#ifndef GlastEvent_MCIntegratingHits_H
#define GlastEvent_MCIntegratingHits_H 1
...
class MCIntegratingHits : virtual public ContainedObject {
...
public:
    ...
    /// Constructors
    MCIntegratingHits() : m_packedFlags(0)
    {}
    /// Destructor
    ~MCIntegratingHits(){}
...
// Definition of all container types of MCIntegratingHits
template <class TYPE> class ObjectVector;
typedef ObjectVector<MCIntegratingHits>     MCIntegratingHitsVector;
template <class TYPE> class ObjectList;
typedef ObjectList<MCIntegratingHits>       MCIntegratingHitsList;


// Inline codes
#include "GlastEvent/MonteCarlo/MCIntegratingHits.cpp"

#endif // GlastEvent_MCIntegratingHits_H
