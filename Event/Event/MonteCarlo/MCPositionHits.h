// $Header$
#ifndef GlastEvent_MCPositionHits_H
#define GlastEvent_MCPositionHits_H 1
...
//------------------------------------------------------------------------------
//
// ClassName:   MCPositionHits
//  
// Description: Monte Carlo class for a position hit such as tracker
//
// The class MCPositionHits uses the Class Library for HEP
...
class MCPositionHits : virtual public ContainedObject {
...
typedef ObjectVector<MCPositionHits> MCPositionHitsVector;
typedef ObjectList<MCPositionHits>   MCPositionHitsList;


// Inline codes
#include "GlastEvent/MonteCarlo/MCPositionHits.cpp"


#endif    // GlastEvent_MCPositionHits_H
