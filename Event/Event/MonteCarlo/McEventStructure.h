...
public:
    ...
    enum ClassificationBits{  
        ...
        TRKCONVERT = 1<<12, //! Secondaries from gamma conversion
        TRKBREM    = 1<<13, //! Secondaries from Bremstrahlung
        TRKCOMPT   = 1<<14, //! Secondaries from Compton scatter
        TRKPHOT    = 1<<15, //! Secondaries from Photoelectric effect (?)
        TRKOTHER   = 1<<16, //! Secondaries from some other process 
