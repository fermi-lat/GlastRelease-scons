...
inline const VolumeID MCIntegratingHits::volumeID() const
{
  return m_volumeID;
}
...
inline void MCIntegratingHits::setVolumeID( VolumeID value )
{
  m_volumeID = value;
}
...
/// Retrieve energy
inline double MCIntegratingHits::totalEnergy() const
{
...
inline const HepPoint3D& MCIntegratingHits::moment1 () const
{
    return m_moment1seed / m_totalEnergy;
}
inline HepPoint3D& MCIntegratingHits::moment1 ()
{
    return m_moment1seed / m_totalEnergy;
}
...
inline const HepPoint3D& MCIntegratingHits::moment2 () const
{
    return m_moment2seed / m_totalEnergy;
}
inline HepPoint3D& MCIntegratingHits::moment2 ()
{
    return m_moment2seed / m_totalEnergy;
}
...
inline const energyDepositMap& MCIntegratingHits::itemizedEnergy() const
{
  return m_energyItem;
}

inline       energyDepositMap& MCIntegratingHits::itemizedEnergy()
{
  return m_energyItem;
}
...
inline void MCIntegratingHits::setEnergyItems( const energyDepositMap& value )
{
    m_energyItem = value;
    m_totalEnergy = 0.;
...
inline void MCIntegratingHits::clearEnergyItems()
{
    m_energyItem.clear();
    m_totalEnergy = 0.;
    m_moment1seed = HepPoint3D(0., 0., 0.);
...
/// Add an energyItem
inline void MCIntegratingHits::addEnergyItem( const double E, const MCParticle* t)
{
    m_energyItem[t] = E;
...
/// Add an energyItem
inline void MCIntegratingHits::addEnergyItem( const double E, const SmartRef<MCParticle>& t)
{
    m_energyItem[t] = E;
...
inline bool MCIntegratingHits::primaryOrigin() const
{
...
inline void MCIntegratingHits::setPrimaryOrigin( bool value )
{
    if (value){
...
inline StreamBuffer& MCIntegratingHits::serialize( StreamBuffer& s ) const
{
...
inline StreamBuffer& MCIntegratingHits::serialize( StreamBuffer& s )
{
    ContainedObject::serialize(s);
    s >> m_volumeID
      >> m_energyItem(this)
...
inline std::ostream& MCIntegratingHits::fillStream( std::ostream& s ) const
{
