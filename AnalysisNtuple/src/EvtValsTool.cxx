...
//   if(!(m_pTkrTool->getVal("Tkr1YDir",myTkr1YDir,nextCheck).isSuccess())) myTkr1YDir = 0;
  ...
  if(myTkr1ZDir>=0 && myCalNewCfpCalEnergyUB>0)
  ...
  else if(myTkr1ZDir<0 && E1>0)
    {
      ...
      // This is still not optimal for events going out of the cal by the sides (we should use the profile). To be done.
      logerawmin = 1+myTkr1ZDir;
      ...
      if(logeraw>logerawmax)
      ...
      else
        {
          ...
          EvtJointEnergy = E0*weight+E1*(1-weight);
        }
    }
