...
/** @mainpage package AnalysisNtuple
 ...
 @section tools Tools
  ...
  There are currently nine tools: McValsTool, GltValsTool, CalValsTool, 
  TkrValsTool, TkrHitValsTool, VtxValsTool, AcdValsTool, EvtValsTool and
  McAnalValsTool.
  ...
  McAnalValsTool is also special, in that it requires that various nonstandard packages
  have been run. This tool is not run in the standard job.
