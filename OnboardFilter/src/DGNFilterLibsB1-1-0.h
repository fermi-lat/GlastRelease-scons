/** @file DGNFilterLibsB1-0-8.h
*
* @class DGNFilterLibsB1-0-8
*
* @brief Class to allow modification of Diagnostic Filter parameters via Job Options 
*
* @authors T. Usher
*
* $Header$
...
#ifndef __DGNFilterLibsB1_1_0_H
#define __DGNFilterLibsB1_1_0_H

#include "IFilterLibs.h"
#include "EFC_DB/EFC_DB_schema.h"

class DGNFilterLibsB1_1_0 : virtual public IFilterLibs
{
public:
    DGNFilterLibsB1_1_0();
    virtual ~DGNFilterLibsB1_1_0();
