/* ---------------------------------------------------------------------- *//*!
   ...
   \file   TFC_geo_v1r13p0.c
   \brief  Defines the LAT geometry, the starting point is the offline
           version v1r13p0.
...
#if 0  /* -- Jan 11, 2004, defining at the bottom of the ACD bottom row */
...
/* ---------------------------------------------------------------------- *//*!
  ...
  \var   const struct _TFC_geometry TFC_Geo_v1r13p0
  \brief Defines the geometry for the LAT corresponding to the GLEAM tag
         v1r13p0
                                                                          */
/* ---------------------------------------------------------------------- */
const struct _TFC_geometry TFC_Geo_v1r13p0 =
{
   TFC_X_TAG,
   TKR_GEOMETRY,
   ACD_GEOMETRY,
