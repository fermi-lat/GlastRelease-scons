/** @file GammaFilterLibsB1-0-8.h
*
* @class GammaFilterLibsB1-0-8
*
...
#ifndef __GammaFilterLibsB1_1_0_H
#define __GammaFilterLibsB1_1_0_H

#include "IFilterLibs.h"
#include "EFC_DB/EFC_DB_schema.h"

class GammaFilterLibsB1_1_0 : virtual public IFilterLibs
{
public:
    GammaFilterLibsB1_1_0();
    virtual ~GammaFilterLibsB1_1_0();
