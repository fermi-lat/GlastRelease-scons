...
#ifndef __GammaFilterLibsB1_1_3_H
#define __GammaFilterLibsB1_1_3_H

#include "IFilterLibs.h"
#include "EFC_DB/EFC_DB_schema.h"

class GammaFilterLibsB1_1_3 : virtual public IFilterLibs
{
public:
    GammaFilterLibsB1_1_3();
    virtual ~GammaFilterLibsB1_1_3();
