...
#ifndef __GammaFilterLibsB1_1_2_H
#define __GammaFilterLibsB1_1_2_H

#include "IFilterLibs.h"
#include "EFC_DB/EFC_DB_schema.h"

class GammaFilterLibsB1_1_2 : virtual public IFilterLibs
{
public:
    GammaFilterLibsB1_1_2();
    virtual ~GammaFilterLibsB1_1_2();
