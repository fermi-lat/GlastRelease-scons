/**
 * CrHeavyIonPrimaryVertical:
 *   The primary cosmic-ray alpha spectrum (normal incidence) source.
 */

//$Header:

#ifndef CrHeavyIonPrimaryVertical_H
#define CrHeavyIonPrimaryVertical_H
...
class CrHeavyIonPrimaryVertical : public CrSpectrum
{
public:  
  CrHeavyIonPrimaryVertical();
  ~CrHeavyIonPrimaryVertical();
...
#endif // CrHeavyIonPrimaryVertical_H
