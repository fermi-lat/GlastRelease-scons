...
#ifndef CrHeavyIonPrimVertZ_H
#define CrHeavyIonPrimVertZ_H
...
class CrHeavyIonPrimVertZ : public CrSpectrum
{
public:  
  CrHeavyIonPrimVertZ(int z);
  ~CrHeavyIonPrimVertZ();
