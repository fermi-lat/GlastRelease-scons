...
double CrPositronSplash_0003::energy(HepRandomEngine* engine){
...
double CrPositronSplash_0003::upwardFlux(){
  return 311.0;
}
//------------------------------------------------------------
...
// returns energy obeying re-entrant cosmic-ray positron spectrum
double CrPositronSplash_0306::energy(HepRandomEngine* engine){
...
// returns energy integrated downward flux in c/s/m^2/sr
double CrPositronSplash_0306::upwardFlux(){
  return 146.69;
}
//------------------------------------------------------------
...
// returns energy obeying re-entrant cosmic-ray positron spectrum
double CrPositronSplash_0608::energy(HepRandomEngine* engine){
...
// returns energy integrated downward flux in c/s/m^2/sr
double CrPositronSplash_0608::upwardFlux(){
  return 73.15;
}
//------------------------------------------------------------
...
// returns energy obeying re-entrant cosmic-ray positron spectrum
double CrPositronSplash_0809::energy(HepRandomEngine* engine){
...
// returns energy integrated downward flux in c/s/m^2/sr
double CrPositronSplash_0809::upwardFlux(){
  return 73.13;
}
//------------------------------------------------------------
...
// returns energy obeying re-entrant cosmic-ray positron spectrum
double CrPositronSplash_0910::energy(HepRandomEngine* engine){
...
// returns energy integrated downward flux in c/s/m^2/sr
double CrPositronSplash_0910::upwardFlux(){
  return 120.73;
}
//------------------------------------------------------------
...
// returns energy obeying re-entrant cosmic-ray positron spectrum
double CrPositronSplash_1011::energy(HepRandomEngine* engine){
...
// returns energy integrated downward flux in c/s/m^2/sr
double CrPositronSplash_1011::upwardFlux(){
  return 187.45;
}
//------------------------------------------------------------
