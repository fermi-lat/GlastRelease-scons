...
private:
    ...
    unsigned m_IDHit; // TkrCluster Index - code = tower+layer+hit
    int m_IDTower;
    int m_IDPlane;
    //	unsigned m_IDTower;
...
public:
    ...
    void drawTrack(gui::DisplayRep& v, TkrCluster::view, KalHit::TYPE);
    void drawChiSq(gui::DisplayRep& v, TkrCluster::view, KalHit::TYPE);
