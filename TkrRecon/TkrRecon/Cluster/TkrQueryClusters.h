...
public:
    ...
    Point meanHit(Event::TkrCluster::view v, int iplane);
	...
	*/
    Point meanHitInside(Event::TkrCluster::view v, int iplane, double inDistance, Point Pini);
	...
	*/
    Point nearestHitOutside(Event::TkrCluster::view v, int iplane, double inDistance, 
		Point Pini, int& id);
    ...
    int numberOfHitsNear( Event::TkrCluster::view v, int iPlane, double inDistance, Point& x0);
