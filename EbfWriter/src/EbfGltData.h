#ifndef EBF_GLT_DATA_H
#define EBF_GLT_DATA_H
...
class EbfGltData
{
  public:
    ...
    **/
    ...
    {
                           /* Physics triggers                          */
      TKR            =  0, /* Tracker 3 in a row                        */
      TKR_NOT_VETOED =  1, /* Tracker 3 in a row, not vetoed by ACD     */
      CAL_HI         =  2, /* CAL HI in any tower                       */
      CAL_LO         =  3, /* CAL LO in any tower                       */
      CNO            =  4, /* Any ACD CNO discriminator above threshold */
      
      PERIODIC       = 14, /* Periodic (diagnostic trigger)             */
      SOLICITED      = 15  /* Trigger solicited by the CPU              */ 
    };
    ...
    void                fill        (unsigned int       mc_number,
                                     double               mc_time,
    ...
    **/
     ...
     *          in the GLT declaring a trigger (TACK).
     *
     ...
     *   the GLT declaring a trigger. Note that this is not a boolean value,
     *   it is simply 0 if no trigger was declared and non-zero if a trigger
     *   was declared.
    **/
    inline unsigned int isTriggered () const { return m_cnoReqvec & 0xffff; }
