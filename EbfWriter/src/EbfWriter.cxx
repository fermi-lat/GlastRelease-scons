...
//        eventSvc()->retrieveObject("/Event/TriRowBits", rowbits);
        ...
        // Get GltDigi for trigger information
        SmartDataPtr<Event::GltDigi> 
                     glt(eventSvc(), EventModel::Digi::Event+"/GltDigi");
        ...
        if(m_CalEncodeFlag<0) {
          cal.fill    (calDigiCol, glt, m_calCalibSvc,m_calConstants);
        } else {
