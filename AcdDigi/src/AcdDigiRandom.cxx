...
class AcdDigiRandom : public RandomAccess {
public:
  AcdDigiRandom( const std::string& type, const std::string& name, const
		  IInterface* parent):RandomAccess(type,name,parent) {}
};

// Static factory for instantiation of algtool objects
//static ToolFactory<AcdDigiRandom> s_factory;
//const IToolFactory& AcdDigiRandomFactory = s_factory;
DECLARE_TOOL_FACTORY(AcdDigiRandom);
