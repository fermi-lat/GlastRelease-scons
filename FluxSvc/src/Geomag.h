...
//! Evaluate the geomagnetic variables (latitude, longitude, McIlwain
//! L, B field) for any point in orbit.  Specialized for a low-inclination
//! circular orbit at altitude 600 km.
/*! Method: Linear interpolation in tables with a 5-degree grid.  Latitude
    ...
    Patrick Nolan, Stanford University
    First written February 2000.
*/
#ifndef GEOMAG_H
#define GEOMAG_H
