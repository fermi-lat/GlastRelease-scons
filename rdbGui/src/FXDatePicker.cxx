...
namespace FX {
	...
	FXIMPLEMENT(FXDatePickerLabel,FXLabel,FXDatePickerLabelMap,ARRAYNUMBER(FXDatePickerLabelMap))
		...
		FXDatePickerLabel::FXDatePickerLabel(FXComposite* p,FXObject* tgt,FXSelector sel,const FXString& text,FXIcon* ic,FXuint opts,FXint x,FXint y,FXint w,FXint h,FXint pl,FXint pr,FXint pt,FXint pb) :
				...
				long FXDatePickerLabel::onClick(FXObject* obj,FXSelector sel,void* ptr)
				{
				...
				FXVerticalFrame(p,opts,x,y,w,h,pl,pr,pt,pb){
					...
					prev= new FXArrowButton(navframe,this, ID_BUTTON_PREV,FRAME_THICK|FRAME_RAISED|ARROW_LEFT| LAYOUT_CENTER_Y,0,0,0,0,0,0,0,0);
					...
					next = new FXArrowButton(navframe,this, ID_BUTTON_NEXT,FRAME_THICK|FRAME_RAISED| LAYOUT_CENTER_Y |LAYOUT_RIGHT|ARROW_RIGHT,0,0,0,0,0,0,0,0);
				...
				long FXDatePicker::onLabelSelected(FXObject* obj,FXSelector sel,void* ptr)
				{
					
					// selected öabel is not valid
					if(((FXDatePickerLabel*)obj)->getDayValue()==-1) return 1;
					
					if(selected) { selected->setBackColor(getBackColor()); }
				...
				long FXDatePicker::onCmdPrev(FXObject* obj,FXSelector sel,void* ptr)
				{
				...
				long FXDatePicker::onCmdToday(FXObject* obj,FXSelector sel,void* ptr)
				{
				...
				long FXDatePicker::onCmdNext(FXObject* obj,FXSelector sel,void* ptr)
				{
					actualDate.setMonth(actualDate.getMonth()+1);
					fill(actualDate);
					if(target) target->handle(this,FXSEL(SEL_CHANGED,selector),&actualDate);
