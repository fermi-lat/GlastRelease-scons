...
SEHadronPhysics::SEHadronPhysics(const G4String& name, 
				 GlastMS::MultipleScatteringFactory& msFactory)
  :  G4VPhysicsConstructor(name), m_msFactory(msFactory)
{;}

SEHadronPhysics::~SEHadronPhysics()
{;}


void SEHadronPhysics::ConstructParticle()
{
...
void SEHadronPhysics::ConstructProcess()
{
  ...
  pManager->AddProcess(thePionPlusMult, -1, 1, 1);
 ...
 //  pManager->AddProcess(new G4MultipleScattering(), -1, 1, 1);
  pManager->AddProcess(thePionMinusMult, -1, 1, 1);
  pManager->AddProcess(new G4hIonisation(),        -1, 2, 2);
 ...
 //  pManager->AddProcess(new G4MultipleScattering(), -1, 1, 1);
  pManager->AddProcess(theKaonPlusMult, -1, 1, 1);
  pManager->AddProcess(new G4hIonisation(),        -1, 2, 2);
 ...
 //  pManager->AddProcess(new G4MultipleScattering(), -1, 1, 1);
  pManager->AddProcess(theKaonMinusMult, -1, 1, 1);
  pManager->AddProcess(new G4hIonisation(),        -1, 2, 2);
 ...
 //  pManager->AddProcess(new G4MultipleScattering(), -1, 1, 1);
  pManager->AddProcess(theAntiProtonMult, -1, 1, 1);
  pManager->AddProcess(new G4hIonisation(),        -1, 2, 2);
 ...
 //  pManager->AddProcess(new G4MultipleScattering(), -1, 1, 1);
  pManager->AddProcess(theSigmaMinusMult, -1, 1, 1);
  pManager->AddProcess(new G4hIonisation(),        -1, 2, 2);
  ...
  //  pManager->AddProcess(new G4MultipleScattering(), -1, 1, 1);
  pManager->AddProcess(theAntiSigmaMinusMult, -1, 1, 1);
  pManager->AddProcess(new G4hIonisation(),        -1, 2, 2);
  ...
  //  pManager->AddProcess(new G4MultipleScattering(), -1, 1, 1);
  pManager->AddProcess(theSigmaPlusMult, -1, 1, 1);
  pManager->AddProcess(new G4hIonisation(),        -1, 2, 2);
  ...
  //  pManager->AddProcess(new G4MultipleScattering(), -1, 1, 1);
  pManager->AddProcess(theAntiSigmaPlusMult, -1, 1, 1);
  pManager->AddProcess(new G4hIonisation(),        -1, 2, 2);
  ...
  //  pManager->AddProcess(new G4MultipleScattering(), -1, 1, 1);
  pManager->AddProcess(theXiMinusMult, -1, 1, 1);
  pManager->AddProcess(new G4hIonisation(),        -1, 2, 2);
  ...
  //  pManager->AddProcess(new G4MultipleScattering(), -1, 1, 1);
  pManager->AddProcess(theAntiXiMinusMult, -1, 1, 1);
  pManager->AddProcess(new G4hIonisation(),        -1, 2, 2);
  ...
  //  pManager->AddProcess(new G4MultipleScattering(), -1, 1, 1);
  pManager->AddProcess(theOmegaMinusMult, -1, 1, 1);
  pManager->AddProcess(new G4hIonisation(),        -1, 2, 2);
  ...
  //  pManager->AddProcess(new G4MultipleScattering(), -1, 1, 1);
  pManager->AddProcess(theAntiOmegaMinusMult, -1, 1, 1);
  pManager->AddProcess(new G4hIonisation(),        -1, 2, 2);
