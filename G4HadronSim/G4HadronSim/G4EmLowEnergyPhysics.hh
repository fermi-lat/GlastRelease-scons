...
#ifndef G4EmLowEnergyPhysics_h
#define G4EmLowEnergyPhysics_h 1
...
class G4EmLowEnergyPhysics : public G4VPhysicsConstructor
{
public:
  //  G4EmLowEnergyPhysics(const G4String& name = "EMlow", G4int ver = 1,
  //	      G4bool msc=true);
  // to add GLAST MCS & Ionisation
  
  G4EmLowEnergyPhysics(const G4String& name, G4int ver,
		      GlastMS::MultipleScatteringFactory& msfactory,
		      GlastMS::EnergyLossFactory& eLossFactory );
		      //		      G4bool msc=true, 

  virtual ~G4EmLowEnergyPhysics();
