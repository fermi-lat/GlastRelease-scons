...
#ifndef G4MultipleScatteringFL_h
#define G4MultipleScatteringFL_h 1
...
class G4MultipleScatteringFL : public G4VContinuousDiscreteProcess

{
 public:    // with description

   G4MultipleScatteringFL(const G4String& processName="msc");

  ~G4MultipleScatteringFL();
 ...
 //  hide assignment operator as  private
   G4MultipleScatteringFL & operator = (const G4MultipleScatteringFL &right);
   G4MultipleScatteringFL ( const G4MultipleScatteringFL &);
...
#include "GlastMS/G4MultipleScatteringFL.icc"
} 
#endif
